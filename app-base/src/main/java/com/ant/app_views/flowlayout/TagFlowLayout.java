package com.ant.app_views.flowlayout;
...
public class TagFlowLayout extends FlowLayout
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            finalTagViewContainer.setOnClickListener(new View.OnClickListener() {
                @Override
