...
import com.ant.app_utils.SdCardTool;
    ...
    public static Uri buildUri(Context mContext, String fileName) {
        ...
        if (SdCardTool.isMounted()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                return FileProvider.getUriForFile(mContext, AppBaseConfig.getAuthority(mContext), new File(Environment.getExternalStorageDirectory(), fileName));
            }
