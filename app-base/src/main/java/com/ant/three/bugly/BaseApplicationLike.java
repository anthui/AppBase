...
//                        String.format(Locale.getDefault(), "%shake %d%%",
...
//        Bugly.init(getApplication(), "4661c8a1c7", true);
//
//        //网络请求 retrofit 初始化
//
//        Util.init(getApplication());
//
...
//        //   UMConfigure.init(getApplication(), UMConfigure.DEVICE_TYPE_PHONE, "5a333d68a40fa33fd8000126");
...
//
//    //分包时使用
//    public abstract void install(Context base);
//
//    //创建时 提供部分数据初始化
