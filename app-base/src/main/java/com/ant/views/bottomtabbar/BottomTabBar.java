package com.ant.views.bottomtabbar;
...
import com.ant.views.bottomtabbar.custom.CustomFragmentTabHost;
...
public class BottomTabBar extends LinearLayout {
    ...
    public void setBottomBarNum(int i, int num) {
    ...
    public BottomTabBar addTabItem(String name, int imgIdSelect, int imgIdUnSelect, Class fragmentClass) {
        return addTabItem(name, ContextCompat.getDrawable(context, imgIdSelect), ContextCompat.getDrawable(context, imgIdUnSelect), fragmentClass, false);
    }

    public BottomTabBar addTabItem(String name, int imgIdSelect, int imgIdUnSelect, Class fragmentClass, boolean showCenter) {
        return addTabItem(name, ContextCompat.getDrawable(context, imgIdSelect), ContextCompat.getDrawable(context, imgIdUnSelect), fragmentClass, showCenter);
    }
    ...
    public BottomTabBar addTabItem(final String name, Drawable drawableSelect, Drawable drawableUnSelect, Class fragmentClass, boolean ishow) {
        tabIdList.add(TextUtils.isEmpty(name) ? fragmentClass.getName() : name);
        mTabHost.addTab(mTabHost.newTabSpec(TextUtils.isEmpty(name) ? fragmentClass.getName() : name)
                .setIndicator(getTabItemView(TextUtils.isEmpty(name) ? fragmentClass.getName() : name, drawableSelect, drawableUnSelect, ishow)), fragmentClass, null);
        return this;
    }
    ...
    private View getTabItemView(String name, Drawable drawableSelect, Drawable drawableUnSelect, boolean isShow) {
        View view = LayoutInflater.from(context).inflate(R.layout.tab_item, null);
