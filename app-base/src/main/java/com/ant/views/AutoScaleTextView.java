...
public class AutoScaleTextView extends AppCompatTextView {
    ...
    public AutoScaleTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.minTextSize = a.getDimension(R.styleable.AutoScaleTextView_minTextSize, 5);
        a.recycle();
        this.preferredTextSize = this.getTextSize();
       // Log.e(TAG, "this.preferredTextSize = " + this.preferredTextSize + ", this.minTextSize = " + this.minTextSize);
...
//        Log.e(TAG, "targetWidth = " + targetWidth);
      ...
      //  Log.e(TAG, "this.preferredTextSize = " + tempPreferredTextSize + ", this.minTextSize = " + tempMinTextSize);
      ...
      //  Log.e(TAG, "this.minTextSize = " + tempMinTextSize);
