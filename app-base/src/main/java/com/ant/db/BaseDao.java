...
public abstract class BaseDao<T, Integer> {
    ...
    public BaseDao(Class<T> clazz) {
        this.clazz = clazz;
        mContext = AntApplication.getInstance();
...
//        return mDatabaseHelper.getDao(clazz);
    ...
    public abstract DatabaseHelper getDataBaseHeplper(Context context);
     ...
     * @throws SQLException SQLException异常
     */
    public int insert(T t) throws SQLException {//Dao<T, Integer> dao = getDao();
     ...
     * @throws SQLException SQLException异常
     */
    public int deleteByIds(List<java.lang.Integer> ids) throws SQLException {
