...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public static void initTopMessage() {
        REFRESH_HEADER_PULLING = null;//"下拉可以刷新";
        REFRESH_HEADER_REFRESHING = null;//"正在刷新...";
        REFRESH_HEADER_LOADING = null;//"正在加载...";
        REFRESH_HEADER_RELEASE = null;//"释放立即刷新";
        REFRESH_HEADER_FINISH = null;//"刷新完成";
        REFRESH_HEADER_FAILED = null;//"刷新失败";
        REFRESH_HEADER_UPDATE = null;//"上次更新 M-d HH:mm";
        REFRESH_HEADER_SECONDARY = null;//"释放进入二楼";
    }
