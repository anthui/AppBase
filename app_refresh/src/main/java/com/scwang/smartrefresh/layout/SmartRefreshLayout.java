...
//    }
     ...
     * Recommended { com.scwang.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * <p>
     * 设置多功能监听器
     * 建议使用 { com.scwang.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     *
     ...
     * Recommended { com.scwang.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 { com.scwang.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     *
...
//**************************************以下为根据需添加的****************************
     ...
     * 1、以下内容
     * 2、默认的刷新、加载控件
     *3、修改mEnableLoadMoreWhenContentNotFull 不满一页，不让加载
     * */
     ...
     * @return SmartRefreshLayout
     */
    public SmartRefreshLayout setEnableApple(boolean enableApple) {
        setEnableOverScrollDrag(enableApple);
        if (enableApple) {
     ...
     * 结束加载
     */
    public void loadFinish(int pageIndex, int pageTotalCount) {
