...
public final class DataUrlLoader<Model, Data> implements ModelLoader<Model, Data> {
    ...
    public boolean handles(@NonNull Model model) {
        ...
        LogUtil.e("msg  model=== " + model.toString());
    ...
    private static final class DataUriFetcher<Data> implements DataFetcher<Data> {
        ...
        DataUriFetcher(String dataUri, com.bumptech.glide.load.model.DataUrlLoader.DataDecoder<Data> reader) {
    ...
    public static final class StreamFactory<Model> implements ModelLoaderFactory<Model, InputStream> {
        ...
        private final com.bumptech.glide.load.model.DataUrlLoader.DataDecoder<InputStream> opener;

        public StreamFactory() {
            opener = new com.bumptech.glide.load.model.DataUrlLoader.DataDecoder<InputStream>() {
                @Override
                public InputStream decode(String url) {

                    LogUtil.e("msg=============url==  " + url);
